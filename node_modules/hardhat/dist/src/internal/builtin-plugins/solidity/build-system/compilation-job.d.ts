...
export declare class CompilationJobImplementation implements CompilationJob {
    ...
    constructor(dependencyGraph: DependencyGraphImplementation, solcConfig: SolidityCompilerConfig, solcLongVersion: string, hooks: HookManager, sharedContentHashes?: Map<string, string>);
